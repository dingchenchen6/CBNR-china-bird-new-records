...
# 服务器端生成 Figure 2 可编辑 PPTX（含地图 + Sankey）
# ============================================================
...
cat("Building editable Figure 2 composite PPTX...\n")
ppt <- read_pptx()
